...
class ExecutorManager {
    ...
    private Map<String, ExecuteGroupInfo> mGroupInfoMap;
    ...
    private void cancelExecuteInfoImp(Callable callable, boolean force) {
        ...
        if(callable != null){
            ...
            ExecuteGroupInfo groupInfo = mGroupInfoMap.get(getValidGroupName(executeInfo.mGroupName));
            if(groupInfo != null){
                if(future != null){
    ...
    private void handleExecuteDone(Callable obj) {
        ...
        if(mAllTaskInfoMap.containsKey(obj)){
            ...
            ExecuteGroupInfo executeGroupInfo = mGroupInfoMap.get(groupName);
            if(executeInfo != null){
        ...
        for(String groupName : mGroupInfoMap.keySet()){
            ExecuteGroupInfo groupInfo = mGroupInfoMap.get(groupName);
